                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\MultithreadedRendering11_VS.hlsl", nullptr, "VSMain", "vs_4_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pVertexShaderBuffer ) );

    ID3DBlob* pPixelShaderBuffer = nullptr;
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\MultithreadedRendering11_PS.hlsl", nullptr, "PSMain", "ps_4_0",
