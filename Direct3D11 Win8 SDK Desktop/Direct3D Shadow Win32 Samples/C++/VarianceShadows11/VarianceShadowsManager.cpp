                              ...
                              )  
{
    ...
    {
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\RenderVarianceShadow.hlsl", nullptr, "VSMain", m_cvsModel,
    ...
    if ( !m_ppsRenderVarianceShadowBlob ) 
    {
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\RenderVarianceShadow.hlsl", nullptr, "PSMain", m_cpsModel,
    ...
    {
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\2DQuadShaders.hlsl", nullptr, "VSMain", m_cvsModel,
    ...
    for ( INT iBlurKernelIndex = 0; iBlurKernelIndex < MAXIMUM_BLUR_LEVELS; ++iBlurKernelIndex ) {
        ...
        if ( !m_ppsQuadBlurXBlob[iBlurKernelIndex] )
        {
            V_RETURN( DXUTCompileFromFile( 
                L"\\..\\Media\\Shaders\\2DQuadShaders.hlsl", kernelDefines, "PSBlurX", m_cpsModel,
        ...
        {
            V_RETURN( DXUTCompileFromFile( 
                L"\\..\\Media\\Shaders\\2DQuadShaders.hlsl", kernelDefines, "PSBlurY", m_cpsModel,
    ...
    for( INT iCascadeIndex=0; iCascadeIndex < MAX_CASCADES; ++iCascadeIndex ) 
    {
        ...
        {
            V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\RenderVarianceScene.hlsl", defines, "VSMain", 
        ...
        for( INT iBlendIndex=0; iBlendIndex < 2; ++iBlendIndex ) 
        {
            for( INT iIntervalIndex=0; iIntervalIndex < 2; ++iIntervalIndex ) 
            {
                ...
                {
                    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\RenderVarianceScene.hlsl", defines, "PSMain", 
