                                     ...
                                     void* pUserContext )
{
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SimpleSample.hlsl", nullptr, "RenderSceneVS", "vs_4_0_level_9_1", D3DCOMPILE_ENABLE_STRICTNESS, 0,
                                   &pVertexShaderBuffer ) );

    ID3DBlob* pPixelShaderBuffer = nullptr;
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SimpleSample.hlsl", nullptr, "RenderScenePS", "ps_4_0_level_9_1", D3DCOMPILE_ENABLE_STRICTNESS, 0, 
                                   &pPixelShaderBuffer ) );
