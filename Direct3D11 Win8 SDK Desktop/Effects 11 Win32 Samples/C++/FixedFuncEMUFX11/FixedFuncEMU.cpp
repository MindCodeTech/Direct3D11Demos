                                      ...
                                      void* pUserContext )
{
    ...
    WCHAR str[MAX_PATH];
    V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"\\..\\Media\\Shaders\\FixedFuncEMU.fx" ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\FixedFuncEMU.fx", nullptr, "none", "fx_5_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pEffectBuffer ) );
