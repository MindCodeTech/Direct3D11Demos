                                      ...
                                      void* pUserContext )
{
    ...
    WCHAR str[MAX_PATH];
    V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"\\..\\Media\\Shaders\\DynamicShaderLinkageFX11.fx" ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\DynamicShaderLinkageFX11.fx", nullptr, "none", "fx_5_0", D3DCOMPILE_ENABLE_STRICTNESS, D3DCOMPILE_EFFECT_ALLOW_SLOW_OPS, &pEffectBuffer ) );
