                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SubD11.hlsl", nullptr, "PatchSkinningVS","vs_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobPatchVS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SubD11.hlsl", nullptr, "MeshSkinningVS", "vs_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobMeshVS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SubD11.hlsl", nullptr, "SubDToBezierHS", "hs_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobHS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SubD11.hlsl", nullptr, "SubDToBezierHS4444", "hs_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobHS4444 ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SubD11.hlsl", nullptr, "BezierEvalDS",   "ds_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobDS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SubD11.hlsl", nullptr, "SmoothPS",	   "ps_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobPS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\SubD11.hlsl", nullptr, "SolidColorPS",   "ps_5_0",
