                                        ...
                                        ID3D11Texture2D* pCubeTexture, ID3D11ShaderResourceView* pCubeRV )
{
    ...
    // Create the shaders
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\skybox11.hlsl", nullptr, "SkyboxVS", "vs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobVS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\skybox11.hlsl", nullptr, "SkyboxPS", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobPS ) );
