                                     ...
                                     void* pUserContext )
{
    ...
    // Create the shaders
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ReduceTo1DCS.hlsl", nullptr, "CSMain", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );   
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ReduceToSingleCS.hlsl", nullptr, "CSMain", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\FinalPass.hlsl", nullptr, "PSFinalPass", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\FinalPass.hlsl", nullptr, "PSFinalPassForCPUReduction", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\PSApproach.hlsl", nullptr, "DownScale2x2_Lum", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\PSApproach.hlsl", nullptr, "DownScale3x3", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\PSApproach.hlsl", nullptr, "FinalPass", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\PSApproach.hlsl", nullptr, "DownScale3x3_BrightPass", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\PSApproach.hlsl", nullptr, "Bloom", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\BrightPassAndHorizFilterCS.hlsl", nullptr, "CSMain", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\FilterCS.hlsl", nullptr, "CSVerticalFilter", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\FilterCS.hlsl", nullptr, "CSHorizFilter", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\DumpToTexture.hlsl", nullptr, "PSDump", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\FinalPass.hlsl", nullptr, "QuadVS", "vs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
