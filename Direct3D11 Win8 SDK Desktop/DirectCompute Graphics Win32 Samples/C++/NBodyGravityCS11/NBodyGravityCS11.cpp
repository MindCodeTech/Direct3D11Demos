                                     ...
                                     void* pUserContext )
{
    ...
    // Create the shaders
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ParticleDraw.hlsl", nullptr, "VSParticleDraw", "vs_4_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobRenderParticlesVS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ParticleDraw.hlsl", nullptr, "GSParticleDraw", "gs_4_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobRenderParticlesGS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ParticleDraw.hlsl", nullptr, "PSParticleDraw", "ps_4_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobRenderParticlesPS ) );
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\NBodyGravityCS11.hlsl", nullptr, "CSMain", "cs_4_0",
