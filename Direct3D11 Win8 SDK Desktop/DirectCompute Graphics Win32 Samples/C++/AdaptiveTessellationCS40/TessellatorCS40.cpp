                                                   ...
                                                   ID3D11ComputeShader** pNumVerticesIndicesCS, ID3D11ComputeShader** pTessVerticesCS, ID3D11ComputeShader** pTessIndicesCS )
{
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_NumVerticesIndicesCS.hlsl", define, "CSNumVerticesIndices", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_TessellateVerticesCS.hlsl", define, "CSTessellationVertices", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_TessellateIndicesCS.hlsl", define, "CSTessellationIndices", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
                                   ...
                                   ID3D11Buffer* pBaseVB )
{
    ...
    if ( !s_pEdgeFactorCS )
    {
        ...
        ID3DBlob* pBlobCS = nullptr;
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_EdgeFactorCS.hlsl", nullptr, "CSEdgeFactor", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
        ...
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_ScatterIDCS.hlsl", nullptr, "CSScatterVertexTriIDIndexID", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
        ...
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_ScatterIDCS.hlsl", nullptr, "CSScatterIndexTriIDIndexID", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
