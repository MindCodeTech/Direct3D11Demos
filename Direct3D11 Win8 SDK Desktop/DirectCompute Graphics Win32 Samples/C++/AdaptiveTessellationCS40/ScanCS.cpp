...
HRESULT CScanCS::OnD3D11CreateDevice( ID3D11Device* pd3dDevice )
{
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ScanCS.hlsl", nullptr, "CSScanInBucket", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ScanCS.hlsl", nullptr, "CSScanBucketResult", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\ScanCS.hlsl", nullptr, "CSScanAddBucketResult", "cs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlobCS ) );
