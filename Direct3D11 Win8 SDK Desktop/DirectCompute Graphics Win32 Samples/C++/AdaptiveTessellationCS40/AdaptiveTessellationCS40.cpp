                                     ...
                                     void* pUserContext )
{
    ...
    // find the file
    WCHAR str[MAX_PATH];
    V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"\\..\\Media\\BaseMesh\\BaseMesh.obj" ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\Render.hlsl", nullptr, "RenderVS", "vs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\Render.hlsl", nullptr, "RenderBaseVS", "vs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\Render.hlsl", nullptr, "RenderPS", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
