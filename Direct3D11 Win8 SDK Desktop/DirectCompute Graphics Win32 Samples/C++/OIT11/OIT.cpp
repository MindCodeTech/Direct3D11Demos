...
HRESULT OIT::OnD3D11CreateDevice( ID3D11Device* pDevice )
{
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\OIT_PS.hlsl", nullptr, "FragmentCountPS", "ps_5_0",
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\OIT_CS.hlsl", nullptr, "CreatePrefixSum_Pass0_CS", "cs_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\OIT_CS.hlsl", nullptr, "CreatePrefixSum_Pass1_CS", "cs_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\OIT_PS.hlsl", nullptr, "FillDeepBufferPS", "ps_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
    ...
    V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\OIT_CS.hlsl", nullptr, "SortAndRenderCS", "cs_5_0",
                                   D3DCOMPILE_ENABLE_STRICTNESS, 0, &pBlob ) );
