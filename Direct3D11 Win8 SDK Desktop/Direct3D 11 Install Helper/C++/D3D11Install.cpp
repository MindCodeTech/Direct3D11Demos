...
int PASCAL WinMain( _In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR strCmdLine, _In_ int nCmdShow )
{
    ...
    prg.hEvent1 = CreateEvent( nullptr, FALSE, FALSE, nullptr );
    prg.hEvent2 = CreateEvent( nullptr, FALSE, FALSE, nullptr );
    prg.hThread = (HANDLE)_beginthreadex( nullptr, 0, ProgressThread, &prg, 0, nullptr );
    ...
    for( int i = 0; i < sizeof(msgs)/sizeof(UINT); ++i )
    {
        ...
        MessageBox( nullptr, msg, g_appName, MB_OK );
    }
    return 0;
#endif
    ...
    if( !IsUserAnAdmin() )
    {
        ...
        if ( !settings.bQuiet && !settings.bPassive )
        {
            ...
            MessageBox( nullptr, msg, g_appName, MB_OK | MB_ICONERROR );
        }
        return 2;
    }
    ...
    case D3D11IH_STATUS_INSTALLED:
        ...
        if ( !settings.bQuiet && !settings.bPassive && !settings.bMinimal )
        {
            ...
            MessageBox( nullptr, msg, g_appName, MB_OK | MB_ICONINFORMATION );
        }
        return 0;
    ...
    for(;;)
    {
        ...
        hr = DoUpdateForDirect3D11( dwFlags,
                                    (settings.bQuiet) ? nullptr : ProgressCallback,
                                    &prg, &updateResult );
            ...
            case D3D11IH_PROGRESS_SEARCHING:
                {
                    ...
                    InvalidateRect( prg->hWnd, nullptr, FALSE );
                }
                break;
...
static INT_PTR LocDialogBox( UINT uId, DLGPROC lpDialogFunc )
{
    ...
    return DialogBoxIndirect( g_hInstance, pdlgt, nullptr, lpDialogFunc );
}
...
static HWND LocCreateDialog( UINT uId, DLGPROC lpDialogFunc )
{
    ...
    return CreateDialogIndirect( g_hInstance, pdlgt, nullptr, lpDialogFunc );
}
