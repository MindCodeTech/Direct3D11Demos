                                      ...
                                      void* pUserContext )
{
    ...
    if (supportedFeatureLevel >= D3D_FEATURE_LEVEL_11_0)
    {
        ...
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\DynamicShaderLinkage11_VS.hlsl", nullptr, "VSMain", "vs_5_0",  D3DCOMPILE_ENABLE_STRICTNESS, 0, &pVertexShaderBuffer ) );
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\DynamicShaderLinkage11_PS.hlsl", nullptr, "PSMain", "ps_5_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pPixelShaderBuffer ) );
    ...
    else // Lower feature levels than 11 have no support for Dynamic Shader Linkage - need to use a static setting
    {
        ...
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\DynamicShaderLinkage11_VS.hlsl", Shader_Macros, "VSMain", "vs_4_0",  D3DCOMPILE_ENABLE_BACKWARDS_COMPATIBILITY, 0, &pVertexShaderBuffer ) );
        V_RETURN( DXUTCompileFromFile( L"\\..\\Media\\Shaders\\DynamicShaderLinkage11_PS.hlsl", Shader_Macros, "PSMain", "ps_4_0", D3DCOMPILE_ENABLE_BACKWARDS_COMPATIBILITY, 0, &pPixelShaderBuffer ) );
